...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    _bloc.gameCameraPosition.position = Offset(Random().nextDouble() * -200.0 * _bloc.gameCameraPosition.scale,
        Random().nextDouble() * -200.0 * _bloc.gameCameraPosition.scale);
    _goOnFloor();
                                        ...
                                        MaterialPageRoute<void>(
                                          builder: (BuildContext context) => Provider<GameBloc>(
                                            create: (BuildContext context) =>
                                                GameBloc(moneyManager: NormalMoneyManager()),
                                            child: MainPage(),
                                          ),
                                        ),
                                      );
