...
class AiRobot extends FactoryMaterialModel {
  AiRobot.fromOffset(Offset o)
      : super(o.dx, o.dy, 15000000.0, FactoryMaterialType.robot, state: FactoryMaterialState.crafted);
  ...
  AiRobot.custom(
      ...
      : super.custom(
            ...
            y: y,
            value: value,
            type: FactoryMaterialType.robot,
            size: size,
            state: state,
            rotation: rotation,
            offsetX: offsetX,
  ...
  void drawMaterial(Offset offset, Canvas canvas, double progress, {double opacity = 1.0}) {
    canvas.save();
    canvas.translate(offset.dx, offset.dy - size * 0.5);
    FactoryMaterialModel.getFromType(FactoryMaterialType.robotHead)
      ..size = size
      ..drawMaterial(offset, canvas, progress);
    canvas.restore();

    canvas.save();
    canvas.translate(offset.dx, offset.dy + size * 0.5);
    FactoryMaterialModel.getFromType(FactoryMaterialType.robotBody)
      ..size = size
      ..drawMaterial(offset, canvas, progress);
    canvas.restore();
  }
