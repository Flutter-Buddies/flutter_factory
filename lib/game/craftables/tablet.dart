...
class Tablet extends FactoryMaterialModel {
  Tablet.fromOffset(Offset o)
      : super(o.dx, o.dy, 7600.0, FactoryMaterialType.tablet, state: FactoryMaterialState.crafted);
  ...
  Tablet.custom(
      ...
      : super.custom(
            ...
            y: y,
            value: value,
            type: FactoryMaterialType.tablet,
            size: size,
            state: state,
            rotation: rotation,
            offsetX: offsetX,
  ...
  void drawMaterial(Offset offset, Canvas canvas, double progress, {double opacity = 1.0}) {
    ...
    _frame.addRRect(RRect.fromRectAndRadius(
        Rect.fromCenter(center: Offset.zero, height: _size * 1.9, width: _size * 1.6), Radius.circular(_size * 0.1)));

    final Path _screen = Path();

    _screen.addRect(Rect.fromCenter(center: Offset(0.0, -_size * 0.1), height: _size * 1.5, width: _size * 1.4));
