...
class ElectricGenerator extends FactoryMaterialModel {
  ElectricGenerator.fromOffset(Offset o)
      : super(o.dx, o.dy, 470000.0, FactoryMaterialType.electricGenerator, state: FactoryMaterialState.crafted);

  ElectricGenerator.custom(
      {double x,
      double y,
      double value,
      double size = 8.0,
      ...
      : super.custom(
            ...
            y: y,
            value: value,
            type: FactoryMaterialType.electricGenerator,
            size: size,
            state: state,
            rotation: rotation,
            offsetX: offsetX,
