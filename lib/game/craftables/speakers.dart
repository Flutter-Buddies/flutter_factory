...
class Speakers extends FactoryMaterialModel{
  Speakers.fromOffset(Offset o) : super(o.dx, o.dy, 1500.0, FactoryMaterialType.speakers, state: FactoryMaterialState.crafted);

  Speakers.custom({double x, double y, double value, double size = 8.0, FactoryMaterialState state = FactoryMaterialState.crafted, double rotation, double offsetX, double offsetY}) :
      super.custom(x: x, y: y, value: value, type: FactoryMaterialType.speakers, size: size, state: state, rotation: rotation, offsetX: offsetX, offsetY: offsetY);
