...
class Computer extends FactoryMaterialModel{
  Computer.fromOffset(Offset o) : super(o.dx, o.dy, 540.0, FactoryMaterialType.computer, state: FactoryMaterialState.crafted);

  Computer.custom({double x, double y, double value, double size = 8.0, FactoryMaterialState state = FactoryMaterialState.crafted, double rotation, double offsetX, double offsetY}) :
      super.custom(x: x, y: y, value: value, type: FactoryMaterialType.computer, size: size, state: state, rotation: rotation, offsetX: offsetX, offsetY: offsetY);
