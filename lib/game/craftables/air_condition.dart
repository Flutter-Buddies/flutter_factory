...
class AirConditioner extends FactoryMaterialModel {
  AirConditioner.fromOffset(Offset o)
      : super(o.dx, o.dy, 900.0, FactoryMaterialType.airCondition, state: FactoryMaterialState.crafted);

  AirConditioner.custom(
      {double x,
      double y,
      double value,
      double size = 8.0,
      ...
      : super.custom(
            ...
            y: y,
            value: value,
            type: FactoryMaterialType.airCondition,
            size: size,
            state: state,
            rotation: rotation,
            offsetX: offsetX,
  ...
  void drawMaterial(Offset offset, Canvas canvas, double progress, {double opacity = 1.0}) {
    ...
    _frame.addRRect(RRect.fromRectAndCorners(
        ...
        topLeft: Radius.circular(_size * 0.4),
        topRight: Radius.circular(_size * 0.4)));
