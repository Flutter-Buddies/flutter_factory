...
class Generator extends FactoryMaterialModel{
  Generator.fromOffset(Offset o) : super(o.dx, o.dy, 12000.0, FactoryMaterialType.generator, state: FactoryMaterialState.crafted);

  Generator.custom({double x, double y, double value, double size = 8.0, FactoryMaterialState state = FactoryMaterialState.crafted, double rotation, double offsetX, double offsetY}) :
      super.custom(x: x, y: y, value: value, type: FactoryMaterialType.generator, size: size, state: state, rotation: rotation, offsetX: offsetX, offsetY: offsetY);
