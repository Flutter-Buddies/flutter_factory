...
class WashingMachine extends FactoryMaterialModel {
  WashingMachine.fromOffset(Offset o)
      : super(o.dx, o.dy, 900.0, FactoryMaterialType.washingMachine, state: FactoryMaterialState.crafted);

  WashingMachine.custom(
      {double x,
      double y,
      double value,
      double size = 8.0,
      ...
      : super.custom(
            ...
            y: y,
            value: value,
            type: FactoryMaterialType.washingMachine,
            size: size,
            state: state,
            rotation: rotation,
            offsetX: offsetX,
  ...
  void drawMaterial(Offset offset, Canvas canvas, double progress, {double opacity = 1.0}) {
    ...
    canvas.drawRRect(
        RRect.fromRectAndRadius(
            Rect.fromPoints(Offset(_size * 0.75, -_size * 0.75), Offset(_size * 0.4, -_size * 0.55)),
            Radius.circular(_size * 0.05)),
        _p);
