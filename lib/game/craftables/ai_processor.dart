...
class AiProcessor extends FactoryMaterialModel {
  AiProcessor.fromOffset(Offset o)
      : super(o.dx, o.dy, 2500000.0, FactoryMaterialType.aiProcessor, state: FactoryMaterialState.crafted);
  ...
  AiProcessor.custom(
      ...
      : super.custom(
            ...
            y: y,
            value: value,
            type: FactoryMaterialType.aiProcessor,
            size: size,
            state: state,
            rotation: rotation,
            offsetX: offsetX,
