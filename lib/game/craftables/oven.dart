...
class Oven extends FactoryMaterialModel {
  ...
  void drawMaterial(Offset offset, Canvas canvas, double progress, {double opacity = 1.0}) {
    ...
    _screen.addRRect(RRect.fromRectAndRadius(
        Rect.fromCenter(center: Offset(0.0, _size * 0.1), height: _size * 1.0, width: _size * 1.4),
    ...
    canvas.drawRect(Rect.fromCenter(center: Offset(0.0, _size * 0.05), height: _size * 1.2, width: _size * 1.6), _p);
