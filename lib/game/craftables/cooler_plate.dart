...
class CoolerPlate extends FactoryMaterialModel {
  CoolerPlate.fromOffset(Offset o)
      : super(o.dx, o.dy, 360.0, FactoryMaterialType.coolerPlate, state: FactoryMaterialState.crafted);
  ...
  CoolerPlate.custom(
      ...
      : super.custom(
            ...
            y: y,
            value: value,
            type: FactoryMaterialType.coolerPlate,
            size: size,
            state: state,
            rotation: rotation,
            offsetX: offsetX,
